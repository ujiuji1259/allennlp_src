...
@TokenIndexer.register("japanese_pretrained_transformer_mismatched")
class JapanesePretrainedTransformerMismatchedIndexer(TokenIndexer):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._matched_indexer = JapanesePretrainedTransformerIndexer(
            model_name,
            namespace=namespace,
