...
@TokenEmbedder.register("japanese_pretrained_transformer")
class JapanesePretrainedTransformerEmbedder(TokenEmbedder):
    """
    ...
    def __init__(
        ...
        *,
        ...
        tokenizer = JapanesePretrainedTransformerTokenizer(
            model_name,
