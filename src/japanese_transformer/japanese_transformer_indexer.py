...
@TokenIndexer.register("japanese_pretrained_transformer")
class JapanesePretrainedTransformerIndexer(TokenIndexer):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._allennlp_tokenizer = JapanesePretrainedTransformerTokenizer(
