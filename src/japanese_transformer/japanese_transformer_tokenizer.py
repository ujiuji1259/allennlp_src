...
@Tokenizer.register("japanese_pretrained_transfomer")
class JapanesePretrainedTransformerTokenizer(Tokenizer):
    """
    ...
    def _reverse_engineer_special_tokens(
        ...
        print(self.sequence_pair_mid_tokens, self.sequence_pair_start_tokens, self.sequence_pair_end_tokens)
